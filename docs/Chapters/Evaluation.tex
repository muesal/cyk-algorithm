...
\todo{This may be, since... (consult one note)}
...
\todo{the times for parantheses\_linear are exactly the same, counter is the very same, for both bottom up and top down.}

\todo{run tests with parantheses grammar from last time this should yield very similar running times, }